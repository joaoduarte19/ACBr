...
type
  ...
  { TACBrBancoPetraBradesco }

  TACBrBancoPetraBradesco = class(TACBrBancoBradesco)
  public
...
procedure TACBrBancoPetraBradesco.GerarRegistroHeader400(NumeroRemessa: Integer; ARemessa: TStringList);
var
  wLinha: String;
begin
  ...
  begin
    wLinha:= '0'                                                +  { ID do Registro }
             ...
             PadRight('PETRABANCO', 15)                         +  { Nome do Banco }
...
procedure TACBrBancoPetraBradesco.GerarRegistroTransacao400(ACBrTitulo :TACBrTitulo; ARemessa: TStringList);
var
  LLinha : String;
begin
