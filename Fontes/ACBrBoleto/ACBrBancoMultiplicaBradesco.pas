...
unit ACBrBancoMultiplicaBradesco;
...
type
  ...
  { TACBrBancoMultiplicaBradesco }

  TACBrBancoMultiplicaBradesco = class(TACBrBancoBradesco)
  public
...
procedure TACBrBancoMultiplicaBradesco.GerarRegistroHeader400(NumeroRemessa: Integer; ARemessa: TStringList);
var
  wLinha: String;
begin
  ...
  begin
    wLinha:= '0'                                                +  { ID do Registro }
             ...
             PadRight('MULTIPLICABANCO', 15)                    +  { Nome do Banco }
...
procedure TACBrBancoMultiplicaBradesco.GerarRegistroTransacao400(ACBrTitulo :TACBrTitulo; ARemessa: TStringList);
var
  LLinha : String;
begin
