   ...
   begin
      ...
      begin
         wLinha:= '7' +                                                         // 001 a 001 - ID Registro
                  ...
                  PadLeft(OnlyCPFCNPJAlphaNum(Cedente.CNPJCPF),14,'0') +                 // 004 a 017 - Inscrição da empresa
                  ...
                  PadLeft(OnlyCPFCNPJAlphaNum(Sacado.CNPJCPF),14,'0') +                  // 221 a 234 - CNPJ ou CPF do sacado
