...
begin
  ...
  if AValue = '0012' then
    Result := ECFVersao1200
  else
    raise Exception.CreateFmt('Valor informado [%s] deve estar entre (0001 e 0012)', [AValue]);
end;
