...
type
  ...
  TNFeIniWriter = class(TDFeRTCIniWriter)
  private
    FNFe: TNFe;
    ...
    procedure Gerar_ProcNFe(AINIRec: TMemIniFile; procNFe: TProcDFe);
  public
...
begin
  ...
  AINIRec.WriteString('Identificacao', 'tpAmb', TipoAmbienteToStr(Ide.tpAmb));
  AINIRec.WriteString('Identificacao', 'tpImp', TpImpToStr(Ide.tpImp));
  AINIRec.WriteString('Identificacao', 'tpemis', TipoEmissaoToStr(Ide.tpemis));
  ...
  Gerar_gCompraGov(AINIRec, Ide.gCompraGov);
...
begin
  ...
  Gerar_IBSCBS(AINIRec, Imposto.IBSCBS, Idx, -1);
end;
...
procedure TNFeIniWriter.Gerar_ProcNFe(AINIRec: TMemIniFile; procNFe: TProcDFe);
begin
  if procNFe.nProt <> '' then
  begin
    AINIRec.WriteString('procNFe', 'tpAmb', TipoAmbienteToStr(procNFe.tpAmb));
    AINIRec.WriteString('procNFe', 'verAplic', procNFe.verAplic);
    AINIRec.WriteString('procNFe', 'chNFe', procNFe.chDFe);
