...
const
  NAME_SPACE_NFAG = 'xmlns="http://www.portalfiscal.inf.br/nfag"';

  DSC_INFQRCODE = 'Texto com o QR-Code impresso no DANFAg NFAg.';
  DSC_FINNFAg = 'Finalidade de emissão da NFAg';
  DSC_TPFAT = 'Tipo de Faturamento da NFAg';
  ...
  DSC_CHNFAGFAT = 'Chave de acesso da NFAg faturada';
  ...
  DSC_CHNFAg = 'Chave da NFAg Referenciada';
