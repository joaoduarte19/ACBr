...
type
  ...
  private
    ...
    procedure Ler_InfNFAgSupl(AINIRec: TMemIniFile; infNFAgSupl: TinfNFAgSupl);
    procedure Ler_ProcessamentoNFAg(AINIRec: TMemIniFile; procNFAg: TProcDFe);
...
begin
  ...
  try
    ...
    FNFAg.infNFAg.versao := StringToFloatDef(INIRec.ReadString('infNFAg', 'versao', VersaoNFAgToStr(VersaoDF)),0);
    {
    Ler_Identificacao(INIRec, FNFAg.Ide);
    Ler_Emitente(INIRec, FNFAg.Emit);

    FNFAg.ide.cUF := INIRec.ReadInteger('ide', 'cUF', UFparaCodigoUF(FNFAg.Emit.enderEmit.UF));
    FNFAg.Ide.cMunFG := INIRec.ReadInteger('ide', 'cMunFG', FNFAg.Emit.EnderEmit.cMun);

    Ler_Destinatario(INIRec, FNFAg.Dest);
    Ler_Acessante(INIRec, FNFAg.acessante);
    Ler_gSub(INIRec, FNFAg.gSub);
    Ler_gJudic(INIRec, FNFAg.gJudic);
    Ler_gGrContrat(INIRec, FNFAg.gGrContrat);
    Ler_gMed(INIRec, FNFAg.gMed);
    Ler_gSCEE(INIRec, FNFAg.gSCEE);
    Ler_gConsumidor(INIRec, FNFAg.gSCEE.gConsumidor);
    Ler_gSaldoCred(INIRec, FNFAg.gSCEE.gSaldoCred);
    Ler_gTipoSaldo(INIRec, FNFAg.gSCEE.gTipoSaldo);
    Ler_NFDet(INIRec, FNFAg.NFDet);
    Ler_Total(INIRec, FNFAg.Total);
    Ler_gFat(INIRec, FNFAg.gFat);
    Ler_gANEEL(INIRec, FNFAg.gANEEL);
    Ler_AutorizadosXml(INIRec, FNFAg.autXML);
    Ler_InfAdic(INIRec, FNFAg.InfAdic);
    Ler_InfRespTec(INIRec, FNFAg.infRespTec);
    Ler_InfNFAgSupl(INIRec, FNFAg.infNFAgSupl);

    Ler_ProcessamentoNFAg(INIRec, FNFAg.procNFAg);
    }
  finally
    INIRec.Free;
  end;
...
begin
  ...
  Ide.finNFAg := StrToFinNFAg(AINIRec.ReadString(sSecao, 'finNFAg', '0'));
...
procedure TNFAgIniReader.Ler_Acessante(AINIRec: TMemIniFile;
...
begin
  sSecao := 'gSub';
  gSub.chNFAg := AINIRec.ReadString(sSecao, 'chNFAg', '');
...
procedure TNFAgIniReader.Ler_gJudic(AINIRec: TMemIniFile; gJudic: TgJudic);
var
  sSecao: string;
begin
  sSecao := 'gJudic';
  gJudic.chNFAg := AINIRec.ReadString(sSecao, 'chNFAg', '');
end;

procedure TNFAgIniReader.Ler_gGrContrat(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gSCEE(AINIRec: TMemIniFile; gSCEE: TgSCEE);
var
  sSecao: string;
begin
  sSecao := 'gSCEE';
...
procedure TNFAgIniReader.Ler_gConsumidor(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_EnerAloc(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_EnerInjet(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gSaldoCred(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gTipoSaldo(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gTipoSaldogSaldoCred(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_NFDet(AINIRec: TMemIniFile;
...
begin
  ...
  begin
    ...
    Item.chNFAgAnt := AINIRec.ReadString(sSecao, 'chNFAgAnt', '');
...
begin
  ...
  begin
    ...
    Item.gAjusteNFAgAnt.tpAjuste:= StrTotpAjuste(AINIRec.ReadString(sSecao, 'tpAjuste', '0'));
    Item.gAjusteNFAgAnt.motAjuste:= StrToMotAjuste(AINIRec.ReadString(sSecao, 'motAjuste', '1'));
...
procedure TNFAgIniReader.Ler_DetItem(AINIRec: TMemIniFile; detItem: TdetItem;
  Idx1, Idx2: Integer);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_gTarif(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gAdBand(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_Prod(AINIRec: TMemIniFile; Prod: TProd; Idx1,
  Idx2: Integer);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_Imposto(AINIRec: TMemIniFile; Imposto: TImposto;
  Idx1, Idx2: Integer);
begin
...
procedure TNFAgIniReader.Ler_ICMS(AINIRec: TMemIniFile; ICMS: TICMS; Idx1,
  Idx2: Integer);
var
  sSecao, sFim: string;
begin
...
procedure TNFAgIniReader.Ler_PIS(AINIRec: TMemIniFile; PIS: TPIS; Idx1,
  Idx2: Integer);
var
  sSecao, sFim: string;
begin
...
procedure TNFAgIniReader.Ler_PISEfet(AINIRec: TMemIniFile; PISEfet: TPISEfet;
  Idx1, Idx2: Integer);
var
  sSecao, sFim: string;
begin
...
procedure TNFAgIniReader.Ler_COFINS(AINIRec: TMemIniFile; COFINS: TCOFINS; Idx1,
  Idx2: Integer);
var
  sSecao, sFim: string;
begin
...
procedure TNFAgIniReader.Ler_COFINSEfet(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_RetTrib(AINIRec: TMemIniFile; retTrib: TretTrib;
  Idx1, Idx2: Integer);
var
  sSecao, sFim: string;
begin
...
procedure TNFAgIniReader.Ler_gProcRef(AINIRec: TMemIniFile; gProcRef: TgProcRef;
  Idx1, Idx2: Integer);
var
  sSecao, sFim: string;
begin
...
procedure TNFAgIniReader.Ler_gProc(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gContab(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gANEEL(AINIRec: TMemIniFile; gANEEL: TgANEEL);
begin
  Ler_gHistFat(AINIRec, gANEEL.gHistFat);
end;

procedure TNFAgIniReader.Ler_gHistFat(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gGrandFat(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_AutorizadosXml(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_InfRespTec(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_InfNFAgSupl(AINIRec: TMemIniFile;
...
begin
  ...
  if AINIRec.SectionExists(sSecao) then
  begin
    infNFAgSupl.qrCodNFAg := AINIRec.ReadString(sSecao, 'qrCodNFAg', '');
  end;
end;

procedure TNFAgIniReader.Ler_ProcessamentoNFAg(AINIRec: TMemIniFile;
  procNFAg: TProcDFe);
var
  sSecao: string;
  Ok: Boolean;
begin
  ...
  if AINIRec.SectionExists(sSecao) then
  begin
    procNFAg.tpAmb := StrToTipoAmbiente(ok, AINIRec.ReadString(sSecao, 'tpAmb', ''));
    procNFAg.verAplic := AINIRec.ReadString(sSecao, 'verAplic', '');
    procNFAg.chDFe := AINIRec.ReadString(sSecao, 'chNFAg', '');
    procNFAg.dhRecbto := AINIRec.ReadDateTime(sSecao, 'dhRecbto', 0);
    procNFAg.nProt := AINIRec.ReadString(sSecao, 'nProt', '');
    procNFAg.digVal := AINIRec.ReadString(sSecao, 'digVal', '');
    procNFAg.cStat := AINIRec.ReadInteger(sSecao, 'cStat', 0);
    procNFAg.xMotivo := AINIRec.ReadString(sSecao, 'xMotivo', '');
    procNFAg.cMsg := AINIRec.ReadInteger(sSecao, 'cMsg', 0);
    procNFAg.xMsg := AINIRec.ReadString(sSecao, 'xMsg', '');
  end;
end;

// Reforma Tributária
procedure TNFAgIniReader.Ler_IBSCBS(AINIRec: TMemIniFile; IBSCBS: TIBSCBS; Idx1, Idx2: Integer);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_IBSCBS_gIBSCBS(AINIRec: TMemIniFile; gIBSCBS: TgIBSCBS; Idx1, Idx2: Integer);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_gIBSUF(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gIBSMun(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gCBS(AINIRec: TMemIniFile; gCBS: TgCBSValores; Idx1, Idx2: Integer);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_gTribReg(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_gIBSCredPres(AINIRec: TMemIniFile; gIBSCredPres: TgIBSCBSCredPres; Idx1, Idx2: Integer);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_gCBSCredPres(AINIRec: TMemIniFile; gCBSCredPres: TgIBSCBSCredPres; Idx1, Idx2: Integer);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_gTribCompraGov(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_IBSCBSTot(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_IBSCBSTot_gIBS(AINIRec: TMemIniFile;
  gIBS: TgIBS);
var
  sSecao: string;
begin
...
procedure TNFAgIniReader.Ler_IBSCBSTot_gIBS_gIBSUFTot(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_IBSCBSTot_gIBS_gIBSMunTot(AINIRec: TMemIniFile;
...
procedure TNFAgIniReader.Ler_IBSCBSTot_gCBS(AINIRec: TMemIniFile;
  gCBS: TgCBS);
var
  sSecao: string;
begin
