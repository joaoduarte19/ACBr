...
begin
  ...
  FCTe.Emit.ISUFEmit:= ObterConteudo(ANode.Childrens.Find('ISUFEmit'), tcStr);
...
procedure TCTeXmlReader.Ler_pgtoVinc(const ANode: TACBrXmlNode);
var
  i: Integer;
