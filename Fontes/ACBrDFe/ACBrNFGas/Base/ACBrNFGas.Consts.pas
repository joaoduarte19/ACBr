...
const
  NAME_SPACE_NFGAS = 'xmlns="http://www.portalfiscal.inf.br/nfgas"';

resourcestring
  DSC_INFQRCODE = 'Texto com o QR-Code impresso no DANFGas NFGas.';
  DSC_FINNFGas = 'Finalidade de emissão da NFGas';
  DSC_TPFAT = 'Tipo de Faturamento da NFGas';
  DSC_IDESTR = 'Documento de Identificação do Estrangeiro';
  DSC_INDIEDEST = 'Indicador da IE do Destinatário';
  DSC_IDLIGACAO = 'Código único de Identificação da Ligação';
  DSC_IDCODCLIENTE = 'Código de Identificação do Cliente';
  DSC_TPLIGACAO = 'Tipo de Ligação';
  ...
  DSC_CHNFGasFAT = 'Chave de acesso da NFGas faturada';
  ...
  DSC_CHNFGas = 'Chave da NFGas Referenciada';
  ...
  DSC_VTFS = 'Valor TFS';
  DSC_VTFU = 'Valor TFU';
  DSC_ECON = 'Demonstrativo de economia de agua';
  DSC_ECONACUMULADA = 'Demonstrativo de economia de agua acumulada no período';
  DSC_SPRESTADOR = 'Selo de segurança do prestador';
  DSC_DEMISSSELO = 'Data de emissão do Selo de segurança do prestador';
  DSC_SREGULADOR = 'Selo de segurança do Regulador';
  DSC_NAGENCIAATEND = 'Agencia responsável pelo atendimento';
  DSC_ENDERAGENCIAATEND = 'Endereço da Agencia responsável pelo atendimento';
  DSC_XHISTORICO = 'Nome do histórico para exibição/apresentação';
  DSC_MEDMENSAL = 'Média Mensal de consumo';
  DSC_MEDDIARIA = 'Média Diária de consumo';
  DSC_CONSUMO = 'Consumo no mês';
  DSC_VOLFAT = 'Volume Faturado';
  DSC_TPFAIXACONS = 'Faixa Prevista de Consumo';
  DSC_FATORPOLUICAO = 'Fator de poluição';
  DSC_TPCATEGORIA = 'Categoria da ligação';
  DSC_XCATEGORIA = 'Detalhamento da Categoria';
  DSC_QECONOMIAS = 'Quantidade de economias';
  DSC_NUNIDCONSUMO = 'Número da unidade de consumo';
  DSC_VUNIDCONSUMO = 'Volume por unidade de consumo em m3';
  DSC_VBCTFS = 'Valor BC TFS';
  DSC_PTFS = 'Alíquota do TFS';
  DSC_VBCTFU = 'Valor BC TFU';
  DSC_PTFU = 'Alíquota do TFU';
  DSC_COMPETANALISE = 'Ano e mês referência da analise (AAAAMM)';
  DSC_CONCLUSAO = 'Conclusão da Análise';
  DSC_CPROCESSO = 'Legislação aplicada';
  DSC_SISTEMAABAST = 'Nome do Sistema de abastecimento';
  DSC_XITEMANALISADO = 'Nome do item analisado';
  DSC_NAMOSTRAMINIMA = 'Número de amostra minima';
  DSC_NAMOSTRAANALISADA = 'Número de amostra analisada';
  DSC_NAMOSTRAFPADRAO = 'Número de amostra fora do padrão';
  DSC_NAMOSTRADPADRAO = 'Número de amostra dentro do padrão';
