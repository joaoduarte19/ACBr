...
begin
  ...
  try
    ...
    begin
      ...
      Ler_PagamentosVinculados(INIRec, FBPe.pgtoVinc.pgto);
...
procedure TBPeIniReader.Ler_refDFe(AINIRec: TMemIniFile;
...
procedure TBPeIniReader.Ler_PagamentosVinculados(AINIRec: TMemIniFile;
