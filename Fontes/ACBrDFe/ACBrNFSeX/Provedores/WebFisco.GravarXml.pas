...
type
  ...
  TNFSeW_WebFisco101 = class(TNFSeWClass)
  protected
...
function TNFSeW_WebFisco101.GerarXml: Boolean;
var
  NFSeNode: TACBrXmlNode;
  cSimples: Boolean;
  xAtrib, strAux, locEstab, nifInf, paisTomador: string;
...
begin
  ...
  NFSeNode.AppendChild(AddNode(tcStr, '#', 'fone', 1, 12, 1,
                              NFSe.Tomador.Contato.Telefone, '', True, xAtrib));
  ...
  NFSeNode.AppendChild(AddNode(tcStr, '#', 'per', 1, 6, 1,
                                                         '', '', True, xAtrib));
