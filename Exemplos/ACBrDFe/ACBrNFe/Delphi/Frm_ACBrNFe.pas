...
procedure TfrmACBrNFe.FormDestroy(Sender: TObject);
begin
  ffrmstatus.free;
end;
  ...
  case ACBrNFe1.Status of
    ...
    stNFeStatusServico:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Verificando Status do servico...';
        FfrmStatus.Show;
    ...
    stNFeRecepcao:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Enviando dados da NFe...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNfeRetRecepcao:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Recebendo dados da NFe...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNfeConsulta:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Consultando NFe...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNfeCancelamento:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Enviando cancelamento de NFe...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNfeInutilizacao:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Enviando pedido de Inutilização...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNFeRecibo:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Consultando Recibo de Lote...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNFeCadastro:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Consultando Cadastro...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNFeEmail:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Enviando Email...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNFeCCe:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Enviando Carta de Correção...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
    ...
    stNFeEvento:
      begin
        ...
        FfrmStatus.lblStatus.Caption := 'Enviando Evento...';
        FfrmStatus.Show;
        FfrmStatus.BringToFront;
      end;
  end;
...
//    LoadXML(ACBrNFe1.WebServices.EnvEvento.RetornoWS, WBResposta);
    ...
    MemoDados.Lines.Add('ESTE EVENTO FOI REMOVIDO NA NT2025-002 v.1.40');
//    MemoDados.Lines.Add('Retorno do Evento');
//    MemoDados.Lines.Add('');
//    MemoDados.Lines.Add('Id.........: ' + ACBrNFe1.WebServices.EnvEvento.EventoRetorno.retEvento[0].RetInfEvento.Id);
//    MemoDados.Lines.Add('tpAmb......: ' + TpAmbToStr(ACBrNFe1.WebServices.EnvEvento.EventoRetorno.retEvento[0].RetInfEvento.TpAmb));
...
begin
  ...
  SaveDlg := TSaveDialog.Create(nil);
  try
    ArqINI.Text := ACBrNFe1.NotasFiscais.GerarJSON;
...
//    'Arquivos INI (*.ini)|*.ini|Todos os Arquivos (*.*)|*.*';
  ...
  begin
    ACBrNFe1.NotasFiscais.Clear;
    ACBrNFe1.NotasFiscais.LoadFromJSON(OpenDialog1.FileName);
//    ACBrNFe1.NotasFiscais.Assinar;
