...
class ConsultarCobrancasCobPage extends StatefulWidget {
  const ConsultarCobrancasCobPage({super.key, required this.plugin});

  final ACBrPixCDPlugin plugin;

  @override
  State<ConsultarCobrancasCobPage> createState() => _ConsultarCobrancasCobPageState();
}

class _ConsultarCobrancasCobPageState extends State<ConsultarCobrancasCobPage> {
  ...
  Future<void> _executar() async {
    ...
    try {
      ...
      final r = await widget.plugin.consultarCobrancasCob(
