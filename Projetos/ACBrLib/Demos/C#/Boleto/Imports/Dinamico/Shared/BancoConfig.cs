...
namespace ACBrLib.Boleto
{
    ...
    /// </summary>
    public sealed class BancoConfig : ACBrLibConfigBase<IACBrLibBoleto>
    {
        #region Constructors
        ...
        public BancoConfig(IACBrLibBoleto acbrboleto) : base(acbrboleto, ACBrSessao.BoletoBancoConfig)
        {
        }
