...
namespace ACBrLib.Boleto
{
    ...
    /// </summary>
    public sealed class CedenteConfig : ACBrLibConfigBase<IACBrLibBoleto>
    {
        #region Constructors
        ...
        public CedenteConfig(IACBrLibBoleto acbrboleto) : base(acbrboleto, ACBrSessao.BoletoCedenteConfig)
        {
        }
