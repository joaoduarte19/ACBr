...
{
    internal sealed class ACBrMailHandle : ACBrLibHandleBase
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int MAIL_ConfigLerValor(IntPtr handle, string eSessao, string eChave, StringBuilder buffer, ref int bufferSize);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int MAIL_OpenSSLInfo(IntPtr handle, StringBuilder buffer, ref int bufferSize);
        ...
        protected override string GetLibraryName()
        {
            ...
            if (Environment.OSVersion.Platform == PlatformID.Unix)
                return $"libacbrmail{arch}.so";
            return $"ACBrMail{arch}.dll";
        }

        private static readonly Lazy<ACBrMailHandle> instance = new Lazy<ACBrMailHandle>(() => new ACBrMailHandle());
        public static ACBrMailHandle Instance => instance.Value;
    }
}
