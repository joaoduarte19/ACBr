...
Permite a utilização do componente ACBrLibConsultaCNPJ em projetos Android, facilitando a integração de funcionalidades relacionadas à consulta de CNPJs.
