...
Permite a utilização do componente ACBrLibPIXCD em projetos Android, facilitando a integração de funcionalidades relacionadas ao sistema de pagamentos instantâneos PIX.
