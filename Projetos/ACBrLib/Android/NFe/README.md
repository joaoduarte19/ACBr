...
Permite a utilização do componente ACBrLibNFe em projetos Android, facilitando a integração de funcionalidades relacionadas à emissão e gerenciamento de Notas Fiscais Eletrônicas (NFe).
