...
#### Classe principal da biblioteca ACBrLibCep ####
Importar a classe: [ACBrLibCep](ACBrLibCep/src/main/java/br/com/acbr/lib/cep/ACBrLibCep.java)
...
Na ACBrLibCEP, a configuração essencial é a escolha do WebService de consulta.

<a id="722-exemplo-pratico"></a>
## 7.2.2 Exemplo prático
```java
acbrlibcep.configGravarValor( "CEP", "WebService", "3" ); // Republica Virtual
```

<a id="723-observacoes"></a>
## 7.2.3 Observações
Dependendo do provedor escolhido, pode ser necessário informar também:
- ChaveAcesso
- Usuario
- Senha
- PesquisarIBGE

> **Armazenamento seguro:** credenciais como ChaveAcesso, Usuario e Senha nunca devem ser armazenadas em texto puro no código-fonte ou em SharedPreferences sem criptografia.
> Use EncryptedSharedPreferences, Android Keystore ou outro mecanismo recomendado pelo Android.
